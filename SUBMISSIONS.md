...
|---|---|---|---|---|
| **0.34838** | Jul 15 | `step_12750` (runB) | [`configs/decode_params.json`](configs/decode_params.json) (final: per-language α/β/beam from enlarged-dev sweep) | **primary submission** |
